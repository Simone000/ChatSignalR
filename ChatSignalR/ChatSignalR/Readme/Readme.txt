//hostarlo fuori IIS (in una applicazione, windows service, azure worker role, ecc..)
http://www.asp.net/signalr/overview/signalr-20/getting-started-with-signalr-20/tutorial-signalr-20-self-host

//hostarlo dentro IIS
1) NugetManager => signalr
2) Add => SignalR Hub Class (v2)
3) Add => OWIN Startup Class
4) aggiungere app.MapSignalR(); in Configuration(...) di Startup
